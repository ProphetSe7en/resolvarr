...
func TestMaskQbitURL(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			in:   "http://192.168.0.5:7476/proxy/0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
			want: "http://192.168.0.5:7476/proxy/0123" + repeat56Stars() + "cdef",
		},
		{
...
func TestIsMaskedQbitURL(t *testing.T) {
	cases := []struct {
		...
		{
			"clean_real_url",
			"http://192.168.0.5:7476/proxy/0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
			false,
		},
		{
			"direct_qbit",
